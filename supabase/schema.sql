...
--   2. supabase/repair_phases_01_to_03.sql
--   3. supabase/phase_04_structured_homework_builder.sql
--   4. supabase/phase_06_structured_homework_builder.sql
--   5. supabase/repair_and_improve_phase_04_builder.sql  -- builder repair (autosave IDs, resources, comments)
...
--  12. supabase/fix_phase_08_feedback_and_comment_bank_ux.sql
--  13. Later phase_06 fix_* migrations as needed for live repairs
--
...
--   supabase/fix_phase_08_scanned_pdf_marking_access.sql
...
-- and _upsert_structure_block treating scanned_homework_upload as response.
-- ---------------------------------------------------------------------------
